...
import io.avalia.user.api.model.Registration;
...
public interface RegistrationApi {
    ...
    default ResponseEntity<Void> deleteRegistration(@ApiParam(value = "The name that needs to be deleted",required=true) @PathVariable("id") String id) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid registration supplied"),
        @ApiResponse(code = 404, message = "Registration not found") })
    @RequestMapping(value = "/registration/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Registration> getRegistrationByID(@ApiParam(value = "The name that needs to be fetched. Use user1 for testing. ",required=true) @PathVariable("id") String id) {
